...
int main()
{
  ...
  double K( 0.4 );                  // Transpiration parameter ( +ve = blowing )
  ...
  double K_min( 0.0 );
  double K_step( 0.1 );
  double Sigma_step_initial( 0.025 );
  ...
  //std::complex<double> target(0.87,-0.19);
  std::complex<double> target(0.931,-0.19); // 201x201
  ...
  //TODO need to iterate on K eventually
